...
#                 # widget.Sep(foreground="#baRc2de", linewidth=2, size_percent=70),
#                 widget.GroupBox(
#                     # active="#a6d189",
#                     fontsize=16,
#                     rounded=False,
    ...
    Screen(
        bottom=bar.Bar(
            [   
                ...
                widget.Sep(foreground="#f9e2af",linewidth=2,size_percent=80,padding=2),
                widget.Volume(
                    # emoji = True,
                    fontsize=16,
                    emoji_list=["🔇", "", "", ""],
                ...
                widget.Spacer(length=5),
                widget.Sep(foreground="#cba6f7",linewidth=2,size_percent=80,padding=2),
                widget.Battery(
                    # charge_char="",
                    fontsize=16,
                    charge_char="",
                ...
                widget.Spacer(length=5),
                widget.Sep(foreground="#74c7ec",linewidth=2,size_percent=80,padding=2),
                widget.Clock(
                    fontsize=16,
                    format="  %I:%M %p - %b %e",
                    update_interval=60.0,
                ...
                widget.Spacer(length=5),
                widget.Sep(foreground="#fab387",linewidth=2,size_percent=80,padding=2),
                widget.Systray(fontsize=18),
                widget.Spacer(
                    length=10,
                ),
                widget.TextBox(
